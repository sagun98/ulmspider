	...
	<body>
		<div class="container">
			...
			<header class="clearfix">
				<span>Spread the WEB <span class="bp-icon bp-icon-about" data-content="Login to see applicants for the job"></span></span>
				<h1>ULM Spider</h1>
...
<h2>Login to view the applicants</h2>
			...
			if($insert->execute())
			{
				?><div style=" margin-left: 770px;"><?php echo "Successfully created new credential.";?></div>
										<?php
											...
											?><div style="color:red; margin-left: 800px;">Password too short.</div><?php
