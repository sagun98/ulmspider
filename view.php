...
<div class="stars" style="float: left; height: 100px;width: 300px; margin-right: 1500px; margin-top: 20px; ">
  <form action="" method="post" >
   ...
   <input  style="float: left; margin-left: 105px" type="submit" name="submit_2" value= "Rate <?php echo $first_name?> " >
  </form>
</div>
<br>
...
<div class="stars" style="float: left;height: 100px;width: 300px; ">
  <form action="" method="post" >
    <input class="star star-5" id="star-5" type="radio" name="star" value="5" />
    <label class="star star-5" for="star-5"></label>
    <input class="star star-4" id="star-4" type="radio" name="star" value="4"/>
    ...
    <label class="star star-1" for="star-1"></label>
    <br>
    <input  style="float: left; margin-left: 125px" type="submit" name="submit_2" value= "Rate <?php echo $first_name?> " >
  </form>
</div>
